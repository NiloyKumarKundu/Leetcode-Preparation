...
void solve() {
	...
	int n, k;
	cin >> n >> k;
	int ans1 = upper_bound(Prime.begin(), Prime.end(), n) - Prime.begin();
	int ans2 = upper_bound(Prime.begin(), Prime.end(), k) - Prime.begin();
	// dbg(ans1, ans2, ans1 - ans2);
	cout << ans1 << " " << max(ans1 - ans2, (int) 0) << endl;
}
